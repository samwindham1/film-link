<template>
  <footer id="footer">
    <div class="container">
      <div class="row clear">
        <div class="col-6 col-5-m col-4-l">
          <ul>
            <li>
              <a href="#">Train our model</a>
            </li>
            <li>
              <a href="https://vuejs.org/">Powered by Vue.js</a>
            </li>
            <li>
              <a href="https://github.com/samwindham1/film-link">Github</a>
            </li>
          </ul>
        </div>
        <div class="col-6 col-5-m col-4-l right">
          <ul>
            <li>
              Developed by
            ...
            <li class="tmdb row clear">
              <div class="col-2">
                <a href="https://www.themoviedb.org/">
                  <svg xmlns="http://www.w3.org/2000/svg" id="tmdb-logo" data-name="Layer 1" viewBox="0 0 160.02 174.22">
